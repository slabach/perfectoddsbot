...
func GetGuildInfo(s *discordgo.Session, db *gorm.DB, guildID string, channelId string) (*models.Guild, error) {
	...
	if guildResult.RowsAffected == 0 {
		...
		newGuild := &models.Guild{GuildID: guildID, BetChannelID: channelId, GuildName: guildInfo.Name, PointsPerMessage: 0.5, StartingPoints: 1000, Pool: 0, CardDrawCost: 50, CardDrawCooldownMinutes: 60}
