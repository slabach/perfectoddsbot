...
func registerUncommonCards(deck *[]models.Card) {
	uncommonCards := []models.Card{
		...
		},
		{
			...
			Description: "Choose a user. You randomly swap one card from your inventory with one of theirs.",
		...
		},
		{
			...
			Description: "Choose a user. Target user loses 50 points to the Pool.",
		...
		},
		{
			...
			Description:    "For the next hour, you gain an extra 15 points for every bet you win.",
		...
		},
		{
			...
			Description:  "Three random active users have their card costs doubled for the next 20 minutes.",
		...
		},
		{
			...
			Description: "50/50 chance to either gain 250 points or lose 150 points to the Pool.",
			Expansion:   "Collegiate",
		...
		},
		{
			...
			Description: "Lose 25 points to the Pool and your next bet win payout is cut by 15%.",
			Expansion:   "Collegiate",
