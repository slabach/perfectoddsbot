...
func registerUncommonCards(deck *[]models.Card) {
	uncommonCards := []models.Card{
		...
		// 	Description:    "For the next 24 hours, you gain an extra 15 points for every bet you win.",
		...
		// 	Description:  "Three random users have their card costs doubled for the next hour.",
		...
		// 	Description: "50/50 chance to either gain 150 points or lose 50 points to the Pool.",
		// 	Expansion:   "Collegiate",
