...
func registerRareCards(deck *[]models.Card) {
	rareCards := []models.Card{
		...
		// 	ID:          162,
		// 	Name:        "The Underdog (🏟️)",
		// 	Description: "If you are in the bottom 25% of players, gain 250 points from the Pool. Otherwise gain 100 points.",
		...
		// 	Description: "If you are in 1st place, gain 300 points; however, you must pay 150 points to the Pool as taxes. Otherwise gain 100 points.",
