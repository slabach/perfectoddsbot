...
func registerEpicCards(deck *[]models.Card) {
	epicCards := []models.Card{
		...
		// 	Description: "Choas. Every active player's balance is modified by a random amount between -5% and +5%.",
		// 	Expansion:   "Collegiate",
		...
		// 	ID:          172,
		// 	Name:        "Dark Horse (🏟️)",
		// 	Description: "Heisman dark horse candidate makes it to New York. Gain 400 points if you are in the bottom 25% of players. Otherwise gain 50 points.",
